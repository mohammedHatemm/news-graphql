...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                ...
                'categoryHierarchy' => App\GraphQL\Queries\CategoryHierarchyQuery::class,



                // news queries
                'news' => App\GraphQL\Queries\NewsQuery::class,
                'allNews' => App\GraphQL\Queries\AllNewsQuery::class,
                'newsByCategory' => App\GraphQL\Queries\NewsByCategoryQuery::class,
                'newsByDate' => App\GraphQL\Queries\NewsByDateQuery::class,
    ...
    'types' => [
        ...
        'DeleteResponse' => App\GraphQL\Types\DeleteResponseType::class,
    ],
